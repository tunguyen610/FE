...
namespace Novatic.Controllers
{
    ...
    public class OrderItemMetaController : BaseController
    {
        IOrderItemMetaRepository repository;
        ISystemConfigRepository repositorySystemConfig;
        public OrderItemMetaController(IOrderItemMetaRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper) : base(cacheHelper)
        {
        ...
        [HttpPost]
        [Route("api/Add")]
        public async Task<IActionResult> Add([FromBody] OrderItemMeta model)
        {
        ...
        [HttpPost]
        [Route("api/Update")]
        public async Task<IActionResult> Update([FromBody] OrderItemMeta model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        [HttpPost]
        [Route("api/Delete")]
        public async Task<IActionResult> Delete([FromBody] OrderItemMeta model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        public async Task<IActionResult> DeletePermanently([FromBody] OrderItemMeta model)
        {
            int result = 0;
        ...
        {
            int result = repository.CountOrderItemMeta();
            return result;
        }
    }
}
