        ...
        namespace Novatic.Controllers
        {
            [Route("[controller]")]
            [ApiController]
            public class OrderMetaController : BaseController
            {
                IOrderMetaRepository repository;
                ISystemConfigRepository repositorySystemConfig;
                public OrderMetaController(IOrderMetaRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper )  : base(cacheHelper)
                {
                ...
                [HttpPost]
                [Route("api/Add")]
                public async Task<IActionResult> Add([FromBody]OrderMeta model)
                {
                ...
                [HttpPost]
                [Route("api/Update")]
                public async Task<IActionResult> Update([FromBody]OrderMeta model)
                {
                    if (ModelState.IsValid)
                    {
                        try
                ...
                [HttpPost]
                [Route("api/Delete")]
                public async Task<IActionResult> Delete([FromBody]OrderMeta model)
                {
                    if (ModelState.IsValid)
                    {
                        try
                ...
                public async Task<IActionResult> DeletePermanently([FromBody]OrderMeta model)
                {
                    int result = 0;
                ...
                {
                    int result = repository.CountOrderMeta();
                    return result;
                }
            }
        }
