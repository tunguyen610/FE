        ...
        namespace Novatic.Controllers
        {
            ...
            {
                IOrderPaymentStatusRepository repository;
                ISystemConfigRepository repositorySystemConfig;
                public OrderPaymentStatusController(IOrderPaymentStatusRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper )  : base(cacheHelper)
                {
                ...
                {
                    int result = repository.CountOrderPaymentStatus();
                    return result;
                }
            }
        }
