        ...
        namespace Novatic.Controllers
        {
            ...
            public class OrderStatusController : BaseController
            {
                ...
                public OrderStatusController(IOrderStatusRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper )  : base(cacheHelper)
                {
                ...
                {
                    int result = repository.CountOrderStatus();
                    return result;
                }
            }
        }
