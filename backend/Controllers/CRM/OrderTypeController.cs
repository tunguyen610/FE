        ...
        namespace Novatic.Controllers
        {
            ...
            {
                IOrderTypeRepository repository;
                ISystemConfigRepository repositorySystemConfig;
                public OrderTypeController(IOrderTypeRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper )  : base(cacheHelper)
                {
                ...
                {
                    int result = repository.CountOrderType();
                    return result;
                }
            }
        }
