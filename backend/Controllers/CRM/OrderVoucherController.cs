        ...
        namespace Novatic.Controllers
        {
            ...
            {
                IOrderVoucherRepository repository;
                ISystemConfigRepository repositorySystemConfig;
                public OrderVoucherController(IOrderVoucherRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper )  : base(cacheHelper)
                {
                ...
                [HttpPost]
                [Route("api/Add")]
                public async Task<IActionResult> Add([FromBody]OrderVoucher model)
                {
                ...
                [HttpPost]
                [Route("api/Update")]
                public async Task<IActionResult> Update([FromBody]OrderVoucher model)
                {
                    if (ModelState.IsValid)
                    {
                        try
                ...
                [HttpPost]
                [Route("api/Delete")]
                public async Task<IActionResult> Delete([FromBody]OrderVoucher model)
                {
                    if (ModelState.IsValid)
                    {
                        try
                ...
                public async Task<IActionResult> DeletePermanently([FromBody]OrderVoucher model)
                {
                    int result = 0;
                ...
                {
                    int result = repository.CountOrderVoucher();
                    return result;
                }
            }
        }
