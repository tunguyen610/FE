        ...
        namespace Novatic.Controllers
        {
            ...
            public class ProductBrandController : BaseController
            {
                ...
                public ProductBrandController(IProductBrandRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper )  : base(cacheHelper)
                {
                ...
                {
                    int result = repository.CountProductBrand();
                    return result;
                }
            }
        }
