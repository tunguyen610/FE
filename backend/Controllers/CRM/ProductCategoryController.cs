        ...
        namespace Novatic.Controllers
        {
            ...
            public class ProductCategoryController : BaseController
            {
                ...
                public ProductCategoryController(IProductCategoryRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper )  : base(cacheHelper)
                {
        ...
        [HttpGet]
        [Route("api/SearchById")]
        public async Task<IActionResult> SearchById(string keyword)
        {
            try
            {
                var dataList = await repository.SearchById(keyword);
        ...
        [HttpGet]
                ...
                {
                    int result = repository.CountProductCategory();
                    return result;
                }
            }
        }
