        ...
        namespace Novatic.Controllers
        {
            [Route("[controller]")]
            [ApiController]
            public class ProductDiscountTypeController : BaseController
            {
                IProductDiscountTypeRepository repository;
                ISystemConfigRepository repositorySystemConfig;
                public ProductDiscountTypeController(IProductDiscountTypeRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper )  : base(cacheHelper)
                {
                ...
                [HttpPost]
                [Route("api/Add")]
                public async Task<IActionResult> Add([FromBody]ProductDiscountType model)
                {
                ...
                [HttpPost]
                [Route("api/Update")]
                public async Task<IActionResult> Update([FromBody]ProductDiscountType model)
                {
                    if (ModelState.IsValid)
                    {
                        try
                ...
                [HttpPost]
                [Route("api/Delete")]
                public async Task<IActionResult> Delete([FromBody]ProductDiscountType model)
                {
                    if (ModelState.IsValid)
                    {
                        try
                ...
                public async Task<IActionResult> DeletePermanently([FromBody]ProductDiscountType model)
                {
                    int result = 0;
                ...
                {
                    int result = repository.CountProductDiscountType();
                    return result;
                }
            }
        }
