        ...
        namespace Novatic.Controllers
        {
            ...
            {
                IProductStatusRepository repository;
                ISystemConfigRepository repositorySystemConfig;
                public ProductStatusController(IProductStatusRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper )  : base(cacheHelper)
                {
                ...
                {
                    int result = repository.CountProductStatus();
                    return result;
                }
            }
        }
