        ...
        namespace Novatic.Controllers
        {
            [Route("[controller]")]
            [ApiController]
            public class PromotionMetaController : BaseController
            {
                IPromotionMetaRepository repository;
                ISystemConfigRepository repositorySystemConfig;
                public PromotionMetaController(IPromotionMetaRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper )  : base(cacheHelper)
                {
                ...
                [HttpPost]
                [Route("api/Add")]
                public async Task<IActionResult> Add([FromBody]PromotionMeta model)
                {
                ...
                [HttpPost]
                [Route("api/Update")]
                public async Task<IActionResult> Update([FromBody]PromotionMeta model)
                {
                    if (ModelState.IsValid)
                    {
                        try
                ...
                [HttpPost]
                [Route("api/Delete")]
                public async Task<IActionResult> Delete([FromBody]PromotionMeta model)
                {
                    if (ModelState.IsValid)
                    {
                        try
                ...
                public async Task<IActionResult> DeletePermanently([FromBody]PromotionMeta model)
                {
                    int result = 0;
                ...
                {
                    int result = repository.CountPromotionMeta();
                    return result;
                }
            }
        }
