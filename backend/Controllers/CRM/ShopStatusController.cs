        ...
        namespace Novatic.Controllers
        {
            ...
            {
                IShopStatusRepository repository;
                ISystemConfigRepository repositorySystemConfig;
                public ShopStatusController(IShopStatusRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper )  : base(cacheHelper)
                {
                ...
                [HttpPost]
                [Route("api/Add")]
                public async Task<IActionResult> Add([FromBody]ShopStatus model)
                {
                ...
                [HttpPost]
                [Route("api/Update")]
                public async Task<IActionResult> Update([FromBody]ShopStatus model)
                {
                    if (ModelState.IsValid)
                    {
                        try
                ...
                [HttpPost]
                [Route("api/Delete")]
                public async Task<IActionResult> Delete([FromBody]ShopStatus model)
                {
                    if (ModelState.IsValid)
                    {
                        try
                ...
                public async Task<IActionResult> DeletePermanently([FromBody]ShopStatus model)
                {
                    int result = 0;
                ...
                {
                    int result = repository.CountShopStatus();
                    return result;
                }
            }
        }
