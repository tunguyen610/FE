        ...
        namespace Novatic.Controllers
        {
            ...
            {
                IShopTypeRepository repository;
                ISystemConfigRepository repositorySystemConfig;
                public ShopTypeController(IShopTypeRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper )  : base(cacheHelper)
                {
                ...
                [HttpPost]
                [Route("api/Add")]
                public async Task<IActionResult> Add([FromBody]ShopType model)
                {
                ...
                [HttpPost]
                [Route("api/Update")]
                public async Task<IActionResult> Update([FromBody]ShopType model)
                {
                    if (ModelState.IsValid)
                    {
                        try
                ...
                [HttpPost]
                [Route("api/Delete")]
                public async Task<IActionResult> Delete([FromBody]ShopType model)
                {
                    if (ModelState.IsValid)
                    {
                        try
                ...
                public async Task<IActionResult> DeletePermanently([FromBody]ShopType model)
                {
                    int result = 0;
                ...
                {
                    int result = repository.CountShopType();
                    return result;
                }
            }
        }
