        ...
        namespace Novatic.Controllers
        {
            ...
            {
                ITransactionMetaRepository repository;
                ISystemConfigRepository repositorySystemConfig;
                public TransactionMetaController(ITransactionMetaRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper )  : base(cacheHelper)
                {
                ...
                {
                    int result = repository.CountTransactionMeta();
                    return result;
                }
            }
        }
