        ...
        namespace Novatic.Controllers
        {
            ...
            public class TransactionStatusController : BaseController
            {
                ...
                public TransactionStatusController(ITransactionStatusRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper )  : base(cacheHelper)
                {
                ...
                {
                    int result = repository.CountTransactionStatus();
                    return result;
                }
            }
        }
