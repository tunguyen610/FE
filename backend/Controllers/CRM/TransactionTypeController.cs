        ...
        namespace Novatic.Controllers
        {
            ...
            public class TransactionTypeController : BaseController
            {
                ...
                public TransactionTypeController(ITransactionTypeRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper )  : base(cacheHelper)
                {
                ...
                {
                    int result = repository.CountTransactionType();
                    return result;
                }
            }
        }
