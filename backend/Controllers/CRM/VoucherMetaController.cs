        ...
        namespace Novatic.Controllers
        {
            [Route("[controller]")]
            [ApiController]
            public class VoucherMetaController : BaseController
            {
                IVoucherMetaRepository repository;
                ISystemConfigRepository repositorySystemConfig;
                public VoucherMetaController(IVoucherMetaRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper )  : base(cacheHelper)
                {
                ...
                [HttpPost]
                [Route("api/Add")]
                public async Task<IActionResult> Add([FromBody]VoucherMeta model)
                {
                ...
                [HttpPost]
                [Route("api/Update")]
                public async Task<IActionResult> Update([FromBody]VoucherMeta model)
                {
                    if (ModelState.IsValid)
                    {
                        try
                ...
                [HttpPost]
                [Route("api/Delete")]
                public async Task<IActionResult> Delete([FromBody]VoucherMeta model)
                {
                    if (ModelState.IsValid)
                    {
                        try
                ...
                public async Task<IActionResult> DeletePermanently([FromBody]VoucherMeta model)
                {
                    int result = 0;
                ...
                {
                    int result = repository.CountVoucherMeta();
                    return result;
                }
            }
        }
