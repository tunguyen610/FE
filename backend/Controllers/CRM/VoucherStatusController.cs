        ...
        namespace Novatic.Controllers
        {
            ...
            {
                IVoucherStatusRepository repository;
                ISystemConfigRepository repositorySystemConfig;
                public VoucherStatusController(IVoucherStatusRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper )  : base(cacheHelper)
                {
                ...
                {
                    int result = repository.CountVoucherStatus();
                    return result;
                }
            }
        }
