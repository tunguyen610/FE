        ...
        namespace Novatic.Controllers
        {
            ...
            public class VoucherTypeController : BaseController
            {
                ...
                public VoucherTypeController(IVoucherTypeRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper )  : base(cacheHelper)
                {
                ...
                {
                    int result = repository.CountVoucherType();
                    return result;
                }
            }
        }
