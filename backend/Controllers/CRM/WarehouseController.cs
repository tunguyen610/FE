...
namespace Novatic.Controllers
{
    ...
    public class WarehouseController : BaseController
    {
        ...
        public WarehouseController(IWarehouseRepository _repository, 
        ...
        [HttpPost]
        [Route("api/Add")]
        public async Task<IActionResult> Add([FromBody] Warehouse model)
        {
        ...
        [HttpPost]
        [Route("api/Delete")]
        public async Task<IActionResult> Delete([FromBody] Warehouse model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        public async Task<IActionResult> DeletePermanently([FromBody] Warehouse model)
        {
            int result = 0;
        ...
        {
            int result = repository.CountWarehouse();
            return result;
        }
    }
}
