        ...
        namespace Novatic.Controllers
        {
            [Route("[controller]")]
            [ApiController]
            public class WarehouseMetaController : BaseController
            {
                IWarehouseMetaRepository repository;
                ISystemConfigRepository repositorySystemConfig;
                public WarehouseMetaController(IWarehouseMetaRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper )  : base(cacheHelper)
                {
                ...
                [HttpPost]
                [Route("api/Add")]
                public async Task<IActionResult> Add([FromBody]WarehouseMeta model)
                {
                ...
                [HttpPost]
                [Route("api/Update")]
                public async Task<IActionResult> Update([FromBody]WarehouseMeta model)
                {
                    if (ModelState.IsValid)
                    {
                        try
                ...
                [HttpPost]
                [Route("api/Delete")]
                public async Task<IActionResult> Delete([FromBody]WarehouseMeta model)
                {
                    if (ModelState.IsValid)
                    {
                        try
                ...
                public async Task<IActionResult> DeletePermanently([FromBody]WarehouseMeta model)
                {
                    int result = 0;
                ...
                {
                    int result = repository.CountWarehouseMeta();
                    return result;
                }
            }
        }
