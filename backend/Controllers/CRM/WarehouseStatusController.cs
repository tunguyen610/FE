        ...
        namespace Novatic.Controllers
        {
            [Route("[controller]")]
            [ApiController]
            public class WarehouseStatusController : BaseController
            {
                IWarehouseStatusRepository repository;
                ISystemConfigRepository repositorySystemConfig;
                public WarehouseStatusController(IWarehouseStatusRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper )  : base(cacheHelper)
                {
                ...
                [HttpPost]
                [Route("api/Add")]
                public async Task<IActionResult> Add([FromBody]WarehouseStatus model)
                {
                ...
                [HttpPost]
                [Route("api/Update")]
                public async Task<IActionResult> Update([FromBody]WarehouseStatus model)
                {
                    if (ModelState.IsValid)
                    {
                        try
                ...
                [HttpPost]
                [Route("api/Delete")]
                public async Task<IActionResult> Delete([FromBody]WarehouseStatus model)
                {
                    if (ModelState.IsValid)
                    {
                        try
                ...
                public async Task<IActionResult> DeletePermanently([FromBody]WarehouseStatus model)
                {
                    int result = 0;
                ...
                {
                    int result = repository.CountWarehouseStatus();
                    return result;
                }
            }
        }
