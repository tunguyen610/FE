        ...
        namespace Novatic.Controllers
        {
            ...
            {
                IWarehouseTypeRepository repository;
                ISystemConfigRepository repositorySystemConfig;
                public WarehouseTypeController(IWarehouseTypeRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper )  : base(cacheHelper)
                {
                ...
                [HttpPost]
                [Route("api/Add")]
                public async Task<IActionResult> Add([FromBody]WarehouseType model)
                {
                ...
                [HttpPost]
                [Route("api/Update")]
                public async Task<IActionResult> Update([FromBody]WarehouseType model)
                {
                    if (ModelState.IsValid)
                    {
                        try
                ...
                [HttpPost]
                [Route("api/Delete")]
                public async Task<IActionResult> Delete([FromBody]WarehouseType model)
                {
                    if (ModelState.IsValid)
                    {
                        try
                ...
                public async Task<IActionResult> DeletePermanently([FromBody]WarehouseType model)
                {
                    int result = 0;
                ...
                {
                    int result = repository.CountWarehouseType();
                    return result;
                }
            }
        }
