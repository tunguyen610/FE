...
namespace Novatic.Controllers
{
    ...
    public class AnswerController : BaseController
    {
        ...
        public AnswerController(IAnswerRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper) : base(cacheHelper)
        {
        ...
        {
            int result = repository.CountAnswer();
            return result;
        }
    }
}
