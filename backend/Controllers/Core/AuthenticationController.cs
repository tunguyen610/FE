...
namespace Novatic.Controllers
{
    ...
    public class AuthenticationController : BaseController
    {
        ...
        public AuthenticationController(ICacheHelper cacheHelper,
            ISystemConfigRepository _repositorySystemConfig, IAuthenticationRepository _repository , IAccountRepository _repositoryAccount) : base(cacheHelper)
        {
        ...
        [HttpPost]
        [Route("api/Add")]
        public async Task<IActionResult> Add([FromBody]Authentication model)
        {
        ...
        [HttpPost]
        [Route("api/Update")]
        public async Task<IActionResult> Update([FromBody]Authentication model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        [HttpPost]
        [Route("api/Delete")]
        public async Task<IActionResult> Delete([FromBody]Authentication model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        public async Task<IActionResult> DeletePermanently([FromBody]Authentication model)
        {
            int result = 0;
