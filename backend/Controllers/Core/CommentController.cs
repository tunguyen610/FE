...
namespace Novatic.Controllers
{
    ...
    public class CommentController : BaseController
    {
        ...
        public CommentController(ICacheHelper cacheHelper,
            ISystemConfigRepository _repositorySystemConfig, ICommentRepository _repository, IAccountRepository _repositoryAccount) : base(cacheHelper)
        {
