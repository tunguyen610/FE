...
namespace Novatic.Controllers
{
    ...
    {
        IFeaturedPostRepository repository;
        ISystemConfigRepository repositorySystemConfig;
        IAccountRepository repositoryAccount;
        public FeaturedPostController(ICacheHelper cacheHelper, ISystemConfigRepository _repositorySystemConfig, IFeaturedPostRepository _repository, IAccountRepository _repositoryAccount) : base(cacheHelper)
        {
