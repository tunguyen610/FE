...
namespace Novatic.Controllers
{
    ...
    public class MenuController : BaseController
    {
        ...
        public MenuController(ICacheHelper cacheHelper,ISystemConfigRepository _repositorySystemConfig, IMenuRepository _repository, IAccountRepository _repositoryAccount) : base(cacheHelper)
        {
