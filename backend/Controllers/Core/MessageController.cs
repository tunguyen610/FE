...
namespace Novatic.Controllers
{
    ...
    public class MessageController : BaseController
    {
        ...
        public MessageController(ICacheHelper cacheHelper,
    ISystemConfigRepository _repositorySystemConfig, IMessageRepository _repository, IAccountRepository _repositoryAccount) : base(cacheHelper)
        {
        ...
        public async Task<IActionResult> ListMessage()
        {
            try
            {
                var dataList = await repository.ListMessage();
