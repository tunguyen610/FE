...
namespace Novatic.Controllers
{
    ...
    {
        INotificationStatusRepository repository;
        ISystemConfigRepository repositorySystemConfig;
        public NotificationStatusController(INotificationStatusRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper) : base(cacheHelper)
        {
        ...
        {
            int result = repository.CountNotificationStatus();
            return result;
        }
    }
}
