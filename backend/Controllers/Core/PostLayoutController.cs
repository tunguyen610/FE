...
namespace Novatic.Controllers
{
    ...
    {
        IPostLayoutRepository repository;
        ISystemConfigRepository repositorySystemConfig;
        IAccountRepository repositoryAccount;
        public PostLayoutController(ICacheHelper cacheHelper,
    ISystemConfigRepository _repositorySystemConfig, IPostLayoutRepository _repository, IAccountRepository _repositoryAccount) : base(cacheHelper)
        {
