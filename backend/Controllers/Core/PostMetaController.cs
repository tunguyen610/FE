...
namespace Novatic.Controllers
{
    ...
    {
        IPostMetaRepository repository;
        ISystemConfigRepository repositorySystemConfig;
        IAccountRepository repositoryAccount;
        public PostMetaController(ICacheHelper cacheHelper,
    ISystemConfigRepository _repositorySystemConfig, IPostMetaRepository _repository, IAccountRepository _repositoryAccount) : base(cacheHelper)
        {
