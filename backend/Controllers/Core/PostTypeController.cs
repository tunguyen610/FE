...
namespace Novatic.Controllers
{
    ...
    public class PostTypeController : BaseController
    {
        ...
        public PostTypeController(ICacheHelper cacheHelper,
    ISystemConfigRepository _repositorySystemConfig, IPostTypeRepository _repository, IAccountRepository _repositoryAccount) : base(cacheHelper)
        {
