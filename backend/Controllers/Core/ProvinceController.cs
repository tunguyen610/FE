...
namespace Novatic.Controllers
{
    ...
    public class ProvinceController : BaseController
    {
        ...
        public ProvinceController(ICacheHelper cacheHelper,
    ISystemConfigRepository _repositorySystemConfig, IProvinceRepository _repository, IAccountRepository _repositoryAccount) : base(cacheHelper)
        {
