        ...
        namespace Novatic.Controllers
        {
            ...
            public class QuestionTypeController : BaseController
            {
                ...
                public QuestionTypeController(IQuestionTypeRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper )  : base(cacheHelper)
                {
                ...
                {
                    int result = repository.CountQuestionType();
                    return result;
                }
            }
        }
