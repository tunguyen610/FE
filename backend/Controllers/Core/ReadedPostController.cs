...
namespace Novatic.Controllers
{
    ...
    {
        IReadedPostRepository repository;
        ISystemConfigRepository repositorySystemConfig;
        IAccountRepository repositoryAccount;
        public ReadedPostController(ICacheHelper cacheHelper, ISystemConfigRepository _repositorySystemConfig, IReadedPostRepository _repository, IAccountRepository _repositoryAccount) : base(cacheHelper)
        {
