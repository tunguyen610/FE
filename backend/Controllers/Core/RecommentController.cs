...
namespace Novatic.Controllers
{
    ...
    {
        IRecommentRepository repository;
        ISystemConfigRepository repositorySystemConfig;
        public RecommentController(IRecommentRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper) : base(cacheHelper)
        {
        ...
        [HttpPost]
        [Route("api/Add")]
        public async Task<IActionResult> Add([FromBody] Recomment model)
        {
        ...
        [HttpPost]
        [Route("api/Update")]
        public async Task<IActionResult> Update([FromBody] Recomment model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        [HttpPost]
        [Route("api/Delete")]
        public async Task<IActionResult> Delete([FromBody] Recomment model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        public async Task<IActionResult> DeletePermanently([FromBody] Recomment model)
        {
            int result = 0;
        ...
        {
            int result = repository.CountRecomment();
            return result;
        }
    }
}
