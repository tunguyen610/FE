        ...
        namespace Novatic.Controllers
        {
            ...
            {
                ISurveyMetaRepository repository;
                ISystemConfigRepository repositorySystemConfig;
                public SurveyMetaController(ISurveyMetaRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper )  : base(cacheHelper)
                {
                ...
                {
                    int result = repository.CountSurveyMeta();
                    return result;
                }
            }
        }
