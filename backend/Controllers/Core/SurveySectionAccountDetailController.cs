        ...
        namespace Novatic.Controllers
        {
            ...
            {
                ISurveySectionAccountDetailRepository repository;
                ISystemConfigRepository repositorySystemConfig;
                public SurveySectionAccountDetailController(ISurveySectionAccountDetailRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper )  : base(cacheHelper)
                {
                ...
                {
                    int result = repository.CountSurveySectionAccountDetail();
                    return result;
                }
            }
        }
