        ...
        namespace Novatic.Controllers
        {
            ...
            {
                ISurveySectionRepository repository;
                ISystemConfigRepository repositorySystemConfig;
                public SurveySectionController(ISurveySectionRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper )  : base(cacheHelper)
                {
                ...
                {
                    int result = repository.CountSurveySection();
                    return result;
                }
            }
        }
