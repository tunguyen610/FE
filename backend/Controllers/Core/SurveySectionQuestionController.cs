        ...
        namespace Novatic.Controllers
        {
            ...
            {
                ISurveySectionQuestionRepository repository;
                ISystemConfigRepository repositorySystemConfig;
                public SurveySectionQuestionController(ISurveySectionQuestionRepository _repository, ISystemConfigRepository _repositorySystemConfig, ICacheHelper cacheHelper )  : base(cacheHelper)
                {
                ...
                {
                    int result = repository.CountSurveySectionQuestion();
                    return result;
                }
        [HttpGet]
        [Route("api/ListBySurveySectionId/{surveysectionid}")]
        public async Task<IActionResult> ListBySurveySectionId(int surveysectionid)
        {
            try
            {
                var dataList = await repository.ListBySurveySectionId(surveysectionid);
