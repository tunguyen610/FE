...
namespace Novatic.Controllers
{
    ...
    public class ViewStatusController : BaseController
    {
        ...
        public ViewStatusController(ICacheHelper cacheHelper,
    ISystemConfigRepository _repositorySystemConfig, IViewStatusRepository _repository, IAccountRepository _repositoryAccount) : base(cacheHelper)
        {
        ...
        public async Task<IActionResult> DeletePermanently([FromBody]ViewStatus model)
        {
            int result = 0;
