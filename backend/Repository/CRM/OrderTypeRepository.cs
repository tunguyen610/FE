    ...
    namespace Novatic.Repository
    {
        ...
        {
            NovaticDBContext db;
            public OrderTypeRepository(NovaticDBContext _db)
            {
                db = _db;
            }
            ...
            public async Task<OrderType> Add(OrderType obj)
            {
                ...
                {
                    try {
                        await db.OrderType.AddAsync(obj);
            ...
            public async Task<int> DeletePermanently(int? objId)
            {
                ...
                if (db != null)
                {
                    try {
                        ...
                        var obj = await db.OrderType.FirstOrDefaultAsync(x => x.Id == objId);
    
                        if (obj != null)
                        {
                            //Delete that obj
                            db.OrderType.Remove(obj);
