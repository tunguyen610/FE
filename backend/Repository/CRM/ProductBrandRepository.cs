    ...
    namespace Novatic.Repository
    {
        ...
        {
            NovaticDBContext db;
            public ProductBrandRepository(NovaticDBContext _db)
            {
                db = _db;
            }
            ...
            public async Task<ProductBrand> Add(ProductBrand obj)
            {
                ...
                {
                    try {
                        await db.ProductBrand.AddAsync(obj);
            ...
            public async Task<int> DeletePermanently(int? objId)
            {
                ...
                if (db != null)
                {
                    try {
                        ...
                        var obj = await db.ProductBrand.FirstOrDefaultAsync(x => x.Id == objId);
    
                        if (obj != null)
                        {
                            //Delete that obj
                            db.ProductBrand.Remove(obj);
