    ...
    namespace Novatic.Repository
    {
        ...
        {
            NovaticDBContext db;
            public ProductTypeRepository(NovaticDBContext _db)
            {
                db = _db;
            }
            ...
            public async Task<List<ProductType>> Detail(int? id)
            {
                if (db != null)
                {
                    try {
            ...
            public async Task<ProductType> Add(ProductType obj)
            {
                ...
                {
                    try {
                        await db.ProductType.AddAsync(obj);
            ...
            public async Task<int> DeletePermanently(int? objId)
            {
                ...
                if (db != null)
                {
                    try {
                        ...
                        var obj = await db.ProductType.FirstOrDefaultAsync(x => x.Id == objId);
    
                        if (obj != null)
                        {
                            //Delete that obj
                            db.ProductType.Remove(obj);
