    ...
    namespace Novatic.Repository
    {
        ...
        {
            NovaticDBContext db;
            public QuestionTypeRepository(NovaticDBContext _db)
            {
                db = _db;
            }
            ...
            public async Task<List<QuestionType>> Detail(int? id)
            {
                if (db != null)
                {
                    try {
            ...
            public async Task<QuestionType> Add(QuestionType obj)
            {
                ...
                {
                    try {
                        await db.QuestionType.AddAsync(obj);
            ...
            public async Task<int> DeletePermanently(int? objId)
            {
                ...
                if (db != null)
                {
                    try {
                        ...
                        var obj = await db.QuestionType.FirstOrDefaultAsync(x => x.Id == objId);
    
                        if (obj != null)
                        {
                            //Delete that obj
                            db.QuestionType.Remove(obj);
