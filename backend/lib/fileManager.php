...
/**
 * H3K | Novatic File Manager V2.3.8
...
//Application Title
define('APP_TITLE', 'Novatic Technology Solutions');
            ...
            <div class="container h-100">
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="brand">
                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="121px" viewBox="0 0 238.000000 140.000000" aria-label="H3K Novatic File Manager">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> Novatic File Manager <?php echo VERSION; ?></a></h3></p>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Novatic File Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Novatic File Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'Novatic File Manager<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with Novatic File Manager">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Novatic File Manager';      $tr['en']['AppTitle']           = 'File Manager';
...
echo " 
<script>
$('a .fa-link').click(function(e){
    e.preventDefault();
    var selectedURL = $(this).parent().attr('href');
    console.log(selectedURL);
    //debugger;
    //alert();

    parent.postMessage(selectedURL,\"*\")
    //parent.fileSelect(selectedURL);
});
</script>"
?>
