...
const HomeDefaultProductListing = ({ collectionSlug, title ,idRender}) => {
    ...
    useEffect(() => {
        const data ={}
        data.name = JSON.parse(JSON.stringify(collectionSlug));
        data.id = idRender;
        data.pageIndex=1,
        data.pageSize=6
        getProductsByCollection(data);
    }, [collectionSlug]);
            ...
            <div className="ps-container">
                <div className="ps-section__header">
                    ...
                    <ul className="ps-section__links">
                        <li>
                            <Link href={`/shop?category=${idRender}`}>
                                <a>View All</a>
                            </Link>
                        </li>
                    </ul>
